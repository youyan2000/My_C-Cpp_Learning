...
// Return value: 0 for success, -1 for invalid number, -2 for invalid position, -3 for uninitialized list, -4 for full list, -5 for memory allocation failure
...
int OutputList(const List *plist);                                // print linked list
